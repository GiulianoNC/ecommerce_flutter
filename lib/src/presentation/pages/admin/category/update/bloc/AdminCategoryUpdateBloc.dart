...
class AdminCategoryUpdateBloc extends Bloc<AdminCategoryUpdateEvent, AdminCategoryUpdateState>{
  ...
  Future<void>? _onInitEvent(AdminCategoryUpdateInitEvent event, Emitter<AdminCategoryUpdateState> emit){
    emit(
      state.copyWith(
  ...
  Future<void>? _onNameChanged(NameChanged event, Emitter<AdminCategoryUpdateState> emit){
    emit(
      state.copyWith(
        name:BlocFormItem(
  ...
  Future<void>? _onDescriptionChanged(DescriptionChanged event, Emitter<AdminCategoryUpdateState> emit){
    emit(
      state.copyWith(
