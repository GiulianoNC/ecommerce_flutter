...
class AdminCategoryCreateBloc extends Bloc<AdminCategoryCreateEvent, AdminCategoryCreateState>{
  ...
  Future<void>? _onInitEvent(AdminCategoryCreateInitEvent event, Emitter<AdminCategoryCreateState> emit){
    emit(
      state.copyWith(
        formKey: formKey
      )
  ...
  Future<void>? _onNameChanged(NameChanged event, Emitter<AdminCategoryCreateState> emit){
    emit(
      state.copyWith(
        name:BlocFormItem(
  ...
  Future<void>? _onDescriptionChanged(DescriptionChanged event, Emitter<AdminCategoryCreateState> emit){
    emit(
      state.copyWith(
  ...
  Future<void>? _onResetForm(ResetForm event, Emitter<AdminCategoryCreateState> emit){
